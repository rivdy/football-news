...
SECRET_KEY = 'django-insecure-m2jm3c^@5^mgjys8y!w$8&e@kwod9g5z8!*&p#u+k^fntv%s%y'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",   # <- folder berisi sumber CSS/JS/img saat dev
]

# Folder OUTPUT untuk collectstatic (jangan masukkan ke STATICFILES_DIRS!)
STATIC_ROOT = BASE_DIR / "staticfiles"   # <- kosongkan/biarkan Django isi saat collectstatic
